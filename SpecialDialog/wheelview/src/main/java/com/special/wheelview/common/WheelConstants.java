 ...
 */
package com.special.wheelview.common;
...
public class WheelConstants {
     ...
     * 默认背景
     */
    public static final int SPECIAL_BG = Color.parseColor("#F5EEDC");

    /**
     * common皮肤默认背景
     */
    public static final int WHEEL_SKIN_COMMON_BG = Color.parseColor("#F5EEDC");

    /**
     * holo皮肤默认背景
     */
    public static final int WHEEL_SKIN_HOLO_BG = Color.parseColor("#F5EEDC");

    /**
     * holo皮肤默认选中框颜色
     */
    public static final int WHEEL_SKIN_HOLO_BORDER_COLOR = Color.parseColor("#D2B988");
...
//    public static final int WHEEL_TEXT_COLOR = Color.BLACK;
     ...
     * 滚轮默认文本颜色
     */
    public static final int WHEEL_TEXT_COLOR = Color.parseColor("#895D13");
