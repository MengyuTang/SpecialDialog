 ...
 */
package com.special.wheelview.widget;
...
import com.special.wheelview.adapter.BaseWheelAdapter;
import com.special.wheelview.adapter.SimpleWheelAdapter;
import com.special.wheelview.common.WheelConstants;
import com.special.wheelview.common.WheelViewException;
import com.special.wheelview.graphics.DrawableFactory;
import com.special.wheelview.util.WheelUtils;
...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    public static class WheelViewStyle {
        ...
        public WheelViewStyle(WheelViewStyle style) {
            ...
            this.textColor = WheelConstants.WHEEL_TEXT_COLOR;
            this.selectedTextColor = WheelConstants.WHEEL_TEXT_COLOR;
